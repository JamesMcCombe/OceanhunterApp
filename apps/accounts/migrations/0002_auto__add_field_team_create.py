...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.create'
        db.add_column(u'accounts_team', 'create',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 9, 11, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.create'
        db.delete_column(u'accounts_team', 'create')
