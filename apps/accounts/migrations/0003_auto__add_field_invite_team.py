...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'accounts_invite', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Team']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invite.team'
        db.delete_column(u'accounts_invite', 'team_id')
